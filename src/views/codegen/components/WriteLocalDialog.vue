      ...
      <div class="option-section">
        ...
        <div class="option-row">
          ...
          <el-radio-group
            ...
            size="small"
            @update:model-value="emit('update:writeScope', $event)"
          >
        ...
        <div class="option-row">
          ...
          <el-radio-group
            ...
            size="small"
            @update:model-value="emit('update:overwriteMode', $event)"
          >
...
const props = defineProps({
  ...
  backendDirPath: { type: String, default: "" },
  writeScope: { type: String, default: "all" },
  overwriteMode: { type: String, default: "overwrite" },
  writeProgress: { type: Object, default: () => ({ total: 0, done: 0, percent: 0, current: "" }) },
