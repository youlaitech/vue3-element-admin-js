...
- 优化axios响应数据类型提示（author by [cshaptx4869](https://github.com/cshaptx4869)）
...
- 重构API为静态方法实现模块化管理，并将类型文件重命名为模型文件用于存放接口模型定义（author by [haoxianrui](https://github.com/haoxianrui)）
...
- 取消推荐 Vue 插件 （author by [cshaptx4869](https://github.com/cshaptx4869)）
